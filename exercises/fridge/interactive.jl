...
# ╔═╡ 2fcf0fe7-2eca-4179-9efe-239e47e6ee92
begin
	using MySQL
	using DataFrames
	using Dates
...
# ╔═╡ 40309b56-8b94-4c27-b6ae-21e995e44cc2
using PlutoUI

# ╔═╡ 8daf8d6d-7ff5-4943-82a8-f1d493be841c
begin
...
# ╔═╡ 0c8ac540-025e-47b0-bb62-f95884d0e71e
begin
...
# ╔═╡ c36f7983-26b7-4b9e-9da6-5c4ba4776575
begin
	idx = 51
...
# ╔═╡ a44db997-0054-4df8-85cf-4dee836d15ed
begin
	step(x) = @. 0.5*(sign(x)+1)
	ramp(x) = @. step(x)*x
...
# ╔═╡ 5c8811b3-ec06-4dde-a096-eae1225f8022
x = collect(0:1:10000);

# ╔═╡ 6e9a145d-62e6-4b1c-91b1-24b6b2cbe876
md"""
$(@bind a Slider(1:100000))
$(@bind b Slider(1:1000000))
$(@bind c Slider(1:10000))
$(@bind d Slider(0:100000))
"""

# ╔═╡ 0543c1bf-c512-4c20-b733-e3da61d41a8f
[a, b, c, d/1e8]

# ╔═╡ a376ee82-b18a-4eae-b845-6292dfe1b321
y = model(x, [a, b, c, d/1e8]);

# ╔═╡ 181c4e12-3a94-40a4-8eda-71225488b845
begin
...
julia_version = "1.8.1"
manifest_format = "2.0"
project_hash = "6ab973a8fed974d674ada372e44cbd8d4cb28596"
